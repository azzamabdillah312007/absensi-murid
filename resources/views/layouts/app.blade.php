        ...
        <header class="bg-white shadow">
            <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
                <li class="list-none flex justify-center gap-32">
                    ...
                    <div>
                        <a href="/kelas-saya"
                            class="{{ Request::is('kelas-saya') ? 'text-indigo-600 font-medium' : 'text-black font-medium' }}">Kelas
                            Saya</a>
                        <div
                            class=" {{ Request::is('kelas-saya') ? ' w-18 h-[3px] rounded-full bg-indigo-600' : 'hidden' }} ">
                        </div>
                    </div>
                    <div>
                        <a href="/bantuan"
